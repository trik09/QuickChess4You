...
const LiveEventLeaderboard = () => {
  ...
  const currentUserRank = getCurrentUserRank ? getCurrentUserRank() : null;
          ...
          {leaderboard && leaderboard.length > 0 ? (
            leaderboard.map((participant) => (
              <div 
                ...
                className={`table-row ${
                  participant.userId === (currentUser.id || currentUser._id) ? 'current-user' : ''
...
export default LiveEventLeaderboard;
